  ...
  return (
    <nav className="relative">
      ...
      <motion.div
        ...
        className="w-4 h-4 rounded-full bg-gray-800 fixed top-0 right-0 z-50"
      ></motion.div>
      ...
      <motion.ul
        ...
        } fixed top-0 bottom-0 w-full flex flex-col justify-center items-center transition-all duration-300 text-[#f3f3f3]`}
      >
        <div
